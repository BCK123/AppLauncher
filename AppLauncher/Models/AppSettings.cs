...
namespace AppLauncher.Models
{
    ...
    {
        [JsonPropertyName("shortcutsDirectory")]
        public string? ShortcutsDirectory { get; set; } // 用户选择的目录（若为 null 则使用默认 AppData）
        ...
        public string ShortcutsFilePath
        {
            get
            {
                var baseDir = string.IsNullOrWhiteSpace(ShortcutsDirectory)
